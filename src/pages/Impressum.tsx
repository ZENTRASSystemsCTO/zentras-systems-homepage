        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
          ...
          <AnimatedSection delay={100}>
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                PD Dr. med. Michael Schönfeld<br />
              ...
              <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
              <p className="text-muted-foreground mb-4">
                PD Dr. med. Michael Schönfeld<br />
                PD Dr. med. Kai Laukamp<br />
                [Adresse wie oben]
              </p>
