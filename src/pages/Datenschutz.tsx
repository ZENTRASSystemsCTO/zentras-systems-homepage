          ...
          <AnimatedSection delay={100}>
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                [Name des Hosting-Anbieters]<br />
                [Adresse des Hosting-Anbieters]<br /><br />
                Details entnehmen Sie der Datenschutzerklärung des Anbieters.
              </p>

              <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">4. Allgemeine Hinweise und Pflichtinformationen</h2>
              ...
              <p className="text-muted-foreground mb-4">
                Sie haben das Recht, die Berichtigung unrichtiger oder Vervollständigung Ihrer bei uns 
              ...
              <p className="text-muted-foreground mb-4">
                ...
                zur Erfüllung einer rechtlichen Verpflichtung oder aus Gründen des öffentlichen Interesses 
                erforderlich ist.
              </p>

              <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Recht auf Einschränkung der Verarbeitung</h3>
              <p className="text-muted-foreground mb-4">
              ...
              <p className="text-muted-foreground mb-4">
                Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung automatisiert verarbeiten, 
                in einem gängigen, maschinenlesbaren Format zu erhalten.
              </p>

              <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Beschwerderecht bei der Aufsichtsbehörde</h3>
              <p className="text-muted-foreground mb-4">
